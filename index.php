...
<span style="color: #67E6EC;">K</span>
	...
	<div class="four"> Now just click the submit button and YEEEE!!!! YOUR  TRANSACTION  IS  SUCCESSFUL:)</div> 
          ...
          <br>        
         <a style="margin-left: 600px;color:wheat;" href="https://twitter.com/VMoniss" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-twitter fa-2x"></i></a>
         <a style="margin-left: 10px;color:wheat;"href="https://github.com/Moniss17" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'" ><i class="fab fa-github fa-2x"></i></a>
         <a style="margin-left:10px;color:wheat;"href="https://www.linkedin.com/in/moniss-v-0355041b5/" onm41b5ouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-linkedin fa-2x"></i></a>
         <a style="margin-left: 10px;color:wheat;"href="https://www.instagram.com/moniss_monish/" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-instagram fa-2x"></i></a>
         </span> 
         </div>
</body>
</html>